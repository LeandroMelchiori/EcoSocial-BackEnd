...
CREATE TABLE productos (
                           ...
                           CONSTRAINT fk_producto_emprendimiento
                               FOREIGN KEY (emprendimiento_id)
                                   REFERENCES perfil_emprendimiento(id)
                                   ON DELETE CASCADE,
                           ...
                           CONSTRAINT fk_producto_subcategoria
                               FOREIGN KEY (subcategoria_producto_id)
                                   REFERENCES subcategoria_producto(id)
);
...
CREATE INDEX idx_productos_emprendimiento ON productos(emprendimiento_id);
...
CREATE TRIGGER trg_producto_set_fecha_actualizacion
    ...
    FOR EACH ROW
BEGIN
    IF OLD.fecha_actualizacion IS NULL AND NEW.fecha_actualizacion IS NULL THEN
